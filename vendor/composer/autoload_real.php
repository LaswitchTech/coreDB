...
class ComposerAutoloaderInit925832e9aa846904a4cad53f04b6ae6e
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit925832e9aa846904a4cad53f04b6ae6e::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire925832e9aa846904a4cad53f04b6ae6e($fileIdentifier, $file);
        }
...
function composerRequire925832e9aa846904a4cad53f04b6ae6e($fileIdentifier, $file)
{
